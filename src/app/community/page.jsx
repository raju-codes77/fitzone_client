    ...
    <section className="min-h-screen bg-slate-950 text-white py-16 px-4 md:px-8">
      ...
      <div className="max-w-7xl mx-auto text-center mb-14">
        ...
        <p className="max-w-2xl mx-auto text-slate-400 leading-relaxed">
          Explore discussions, fitness tips, transformation stories,
          and professional advice shared by our trainers and admin team.
        </p>
      </div>
          ...
          >
            ...
            <div className="p-5 flex flex-col flex-1">
              ...
              >
                ...
                <button className="w-full bg-lime-400 hover:bg-lime-300 text-black py-3 rounded-xl font-semibold transition-all duration-300 cursor-pointer">

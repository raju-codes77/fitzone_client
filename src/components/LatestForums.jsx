          ...
          >
            ...
            <div className="p-5 flex-1 flex flex-col justify-between">
              ...
              <div className="mt-5 pt-3 border-t border-slate-800/60">
                <button className="w-full text-center py-2 rounded-lg bg-slate-950 hover:bg-slate-800 border border-slate-800 text-xs font-medium text-slate-300 transition-colors cursor-pointer">
                  Read Discussion
                </button>
              </div>
            </div>
